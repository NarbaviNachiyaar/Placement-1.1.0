...
-- Run once, top to bottom, in Supabase SQL Editor, on an EMPTY database.
-- Every CREATE POLICY has a DROP POLICY IF EXISTS guard, so it's
-- also safe to re-run against a partially-migrated database.
-- ============================================================
